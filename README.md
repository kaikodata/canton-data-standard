...
Each successful verification also leaves a durable, producer-signed
`AuditRecord` on the ledger: the standard's receipt that the verification
happened, visible to the producer and to the verifying party.
